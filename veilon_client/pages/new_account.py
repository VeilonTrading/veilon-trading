...
def create_stripe_checkout_session(plan: dict, user_id: int, user_email: str):
    ...
    try:
        ...
        checkout_session = stripe.checkout.Session.create(
            ...
            mode='payment',
            success_url="http://veilontrading.streamlit.app/New_Account?payment_success=true",
            cancel_url="http://veilontrading.streamlit.app/New_Account?payment_canceled=true",
